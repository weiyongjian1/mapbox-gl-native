    ...
    NSObject* toRawStyleSpecValue(MGLStyleFunction<ObjCType>* styleFunction) {
        ...
        if ([styleFunction isKindOfClass:[MGLCameraStyleFunction class]]) {
            ...
            if (sourceStyleFunction.defaultValue) {
                ...
                rawFunction[@"default"] = toRawStyleSpecValue([(MGLConstantStyleValue<ObjCType> *)sourceStyleFunction.defaultValue rawValue]);
            }
            ...
            if (compositeStyleFunction.defaultValue) {
                ...
                rawFunction[@"default"] = toRawStyleSpecValue([(MGLConstantStyleValue<ObjCType> *)compositeStyleFunction.defaultValue rawValue]);
            }
        }
